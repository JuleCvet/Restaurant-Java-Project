...
public class WasherUp extends Employee {
    ...
    public WasherUp(int ID,String professions, String fullName, String address, GenderType gender, double salary, int employedYears, int destroyedItems) {
        super(ID,professions, fullName, address, gender, salary);
